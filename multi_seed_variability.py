...
ax.set_title(
    f"Same experiment, {NUM_SEEDS} different random seeds -- the spread is the point"
)
ax.legend(loc="lower right", frameon=True)
plt.tight_layout()
plt.savefig("output/seed_variability.png", dpi=150)
plt.close()

print("\nSaved: output/seed_variability.png")
